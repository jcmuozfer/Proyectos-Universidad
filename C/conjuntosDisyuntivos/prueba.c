...
int main()
{
	...
	if (unir(13, 15, P))
		printf("Formada clase de equivalencia {13,15}\n");
	else
		printf("No puede formase la clase de equivalencia {13,15}\n");

	if (unir(7, 0, P))
		printf("Formada clase de equivalencia {7,0}\n");
	else
		printf("No puede formase la clase de equivalencia {7,0}\n");
