...
public class TextIO4GUI {
   ...
   private   BufferedReader standardInput;  // wraps the input stream from Console. (Set in  initializer.)
   private   PrintWriter standardOutput;  // wraps the output stream. (Set in  initializer.)
