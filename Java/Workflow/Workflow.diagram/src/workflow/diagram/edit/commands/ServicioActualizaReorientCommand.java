 ...
 * @generated
 */
public class ServicioActualizaReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ServicioActualizaReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return WorkflowBaseItemSemanticEditPolicy.getLinkConstraints().canExistServicioActualiza_4006(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return WorkflowBaseItemSemanticEditPolicy.getLinkConstraints().canExistServicioActualiza_4006(getOldSource(),
				getNewTarget());
	}
	...
	*/
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setActualiza(null);
		getNewSource().setActualiza(getOldTarget());
	...
	*/
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setActualiza(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
