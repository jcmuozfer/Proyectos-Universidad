 ...
 * @generated
 */
public class ServicioGeneraReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ServicioGeneraReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return WorkflowBaseItemSemanticEditPolicy.getLinkConstraints().canExistServicioGenera_4004(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return WorkflowBaseItemSemanticEditPolicy.getLinkConstraints().canExistServicioGenera_4004(getOldSource(),
				getNewTarget());
	}
	...
	*/
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getGenera().remove(getOldTarget());
		getNewSource().getGenera().add(getOldTarget());
	...
	*/
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getGenera().remove(getOldTarget());
		getOldSource().getGenera().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
