...
public class ActorNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Actor_2002, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.ActorNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
