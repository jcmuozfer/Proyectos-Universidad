 ...
 * @generated
 */
public class BaseDatosNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BaseDatosNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.BaseDatos_2001, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.BaseDatosNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
