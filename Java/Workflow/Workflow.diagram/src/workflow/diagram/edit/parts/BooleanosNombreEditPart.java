 ...
 * @generated
 */
public class BooleanosNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BooleanosNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Booleanos_3013, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.BooleanosNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
