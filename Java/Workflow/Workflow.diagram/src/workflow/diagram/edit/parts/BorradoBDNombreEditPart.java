 ...
 * @generated
 */
public class BorradoBDNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BorradoBDNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.BorradoBD_3007, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.BorradoBDNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
