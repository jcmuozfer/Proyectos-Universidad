 ...
 * @generated
 */
public class ConsultaBDNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ConsultaBDNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.ConsultaBD_3006, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.ConsultaBDNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
