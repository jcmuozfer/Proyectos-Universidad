 ...
 * @generated
 */
public class EnterosNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EnterosNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Enteros_3012, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.EnterosNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
