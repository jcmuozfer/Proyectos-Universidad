...
import workflow.diagram.edit.policies.WorkflowTextSelectionEditPolicy;
 ...
 * @generated
 */
public class EnvioMensajeNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EnvioMensajeNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new WorkflowTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.EnvioMensaje_3004, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.EnvioMensajeNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, WorkflowEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
