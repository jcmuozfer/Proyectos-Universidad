 ...
 * @generated
 */
public class FicheroNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FicheroNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Fichero_3010, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.FicheroNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
