 ...
 * @generated
 */
public class FormularioNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FormularioNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Formulario_3011, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.FormularioNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
