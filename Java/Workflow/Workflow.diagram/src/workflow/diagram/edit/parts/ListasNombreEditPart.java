 ...
 * @generated
 */
public class ListasNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ListasNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Listas_3015, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.ListasNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
