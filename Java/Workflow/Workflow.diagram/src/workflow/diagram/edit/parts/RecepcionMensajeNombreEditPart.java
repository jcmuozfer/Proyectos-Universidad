 ...
 * @generated
 */
public class RecepcionMensajeNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RecepcionMensajeNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.RecepcionMensaje_3005, getParserElement(),
					WorkflowVisualIDRegistry
							.getType(workflow.diagram.edit.parts.RecepcionMensajeNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
