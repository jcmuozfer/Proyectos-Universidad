 ...
 * @generated
 */
public class ServicioNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Servicio_3003, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.ServicioNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
