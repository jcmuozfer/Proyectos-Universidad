 ...
 * @generated
 */
public class StringsNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public StringsNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Strings_3014, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.StringsNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
