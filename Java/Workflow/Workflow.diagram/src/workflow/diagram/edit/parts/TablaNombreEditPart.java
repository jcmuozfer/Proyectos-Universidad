...
public class TablaNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Tabla_3001, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.TablaNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
