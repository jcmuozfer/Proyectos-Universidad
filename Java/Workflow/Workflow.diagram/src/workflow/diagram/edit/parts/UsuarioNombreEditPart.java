 ...
 * @generated
 */
public class UsuarioNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Usuario_3002, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.UsuarioNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
