 ...
 * @generated
 */
public class ValorNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ValorNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Valor_3016, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.ValorNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
