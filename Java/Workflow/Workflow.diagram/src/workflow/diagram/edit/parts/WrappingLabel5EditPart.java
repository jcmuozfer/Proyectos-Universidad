...
public class WrappingLabel5EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.WrappingLabel5EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.ServicioActualiza_4006, getParserElement(),
