...
public class WrappingLabel6EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.WrappingLabel6EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.EnvioMensajeFichero_4007, getParserElement(),
