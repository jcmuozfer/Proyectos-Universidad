...
public class WrappingLabel8EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.WrappingLabel8EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.BorradoBDBorra_4009, getParserElement(),
