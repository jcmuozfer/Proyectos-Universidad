 ...
 * @generated
 */
public class ActorActorFormularioCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return WorkflowPackage.eINSTANCE.getActor_Formulario();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WorkflowNodeDescriptor> childDescriptors = WorkflowDiagramUpdater
				.getActorActorFormularioCompartment_7003SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return FormularioEditPart.VISUAL_ID == WorkflowVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<WorkflowNodeDescriptor> childDescriptors = WorkflowDiagramUpdater
				.getActorActorFormularioCompartment_7003SemanticChildren((View) getHost().getModel());
