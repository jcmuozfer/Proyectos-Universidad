 ...
 * @generated
 */
public class ActorItemSemanticEditPolicy extends WorkflowBaseItemSemanticEditPolicy {
					...
					case FicheroEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it.hasNext();) {
							...
							if (WorkflowVisualIDRegistry
									.getVisualID(incomingLink) == ServicioGeneraEditPart.VISUAL_ID) {
							...
							if (WorkflowVisualIDRegistry
									.getVisualID(incomingLink) == EnvioMensajeFicheroEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										incomingLink.getSource().getElement(), null,
										incomingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					...
					case FormularioEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it.hasNext();) {
							Edge incomingLink = (Edge) it.next();
							if (WorkflowVisualIDRegistry
									.getVisualID(incomingLink) == TablaFormularioEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										incomingLink.getSource().getElement(), null,
										incomingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
							...
							if (WorkflowVisualIDRegistry
									.getVisualID(incomingLink) == UsuarioFormularioEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										incomingLink.getSource().getElement(), null,
										incomingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					...
					case UsuarioEditPart.VISUAL_ID:
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (WorkflowVisualIDRegistry
									.getVisualID(outgoingLink) == UsuarioFormularioEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
					...
					case ServicioEditPart.VISUAL_ID:
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (WorkflowVisualIDRegistry
									.getVisualID(outgoingLink) == ServicioGeneraEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
							...
							if (WorkflowVisualIDRegistry
									.getVisualID(outgoingLink) == ServicioActualizaEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
					...
					case EnvioMensajeEditPart.VISUAL_ID:
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (WorkflowVisualIDRegistry
									.getVisualID(outgoingLink) == EnvioMensajeFicheroEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
					...
					case ConsultaBDEditPart.VISUAL_ID:
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (WorkflowVisualIDRegistry
									.getVisualID(outgoingLink) == ConsultaBDConsultaEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
					...
					case BorradoBDEditPart.VISUAL_ID:
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (WorkflowVisualIDRegistry
									.getVisualID(outgoingLink) == BorradoBDBorraEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
