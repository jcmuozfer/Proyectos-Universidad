 ...
 * @generated
 */
public class BaseDatosBaseDatosTablaCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return WorkflowPackage.eINSTANCE.getBaseDatos_Tabla();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WorkflowNodeDescriptor> childDescriptors = WorkflowDiagramUpdater
				.getBaseDatosBaseDatosTablaCompartment_7001SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return TablaEditPart.VISUAL_ID == WorkflowVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<WorkflowNodeDescriptor> childDescriptors = WorkflowDiagramUpdater
				.getBaseDatosBaseDatosTablaCompartment_7001SemanticChildren((View) getHost().getModel());
