 ...
 * @generated
 */
public class BorradoBDItemSemanticEditPolicy extends WorkflowBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public BorradoBDItemSemanticEditPolicy() {
		super(WorkflowElementTypes.BorradoBD_3007);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (WorkflowVisualIDRegistry.getVisualID(outgoingLink) == BorradoBDBorraEditPart.VISUAL_ID) {
