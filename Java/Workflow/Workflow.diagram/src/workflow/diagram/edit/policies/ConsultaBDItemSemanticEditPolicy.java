 ...
 * @generated
 */
public class ConsultaBDItemSemanticEditPolicy extends WorkflowBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ConsultaBDItemSemanticEditPolicy() {
		super(WorkflowElementTypes.ConsultaBD_3006);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (WorkflowVisualIDRegistry.getVisualID(outgoingLink) == ConsultaBDConsultaEditPart.VISUAL_ID) {
