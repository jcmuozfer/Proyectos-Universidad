 ...
 * @generated
 */
public class EnvioMensajeItemSemanticEditPolicy extends WorkflowBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public EnvioMensajeItemSemanticEditPolicy() {
		super(WorkflowElementTypes.EnvioMensaje_3004);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (WorkflowVisualIDRegistry.getVisualID(outgoingLink) == EnvioMensajeFicheroEditPart.VISUAL_ID) {
