 ...
 * @generated
 */
public class FormularioFormularioCampoCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return WorkflowPackage.eINSTANCE.getFormulario_Campo();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WorkflowNodeDescriptor> childDescriptors = WorkflowDiagramUpdater
				.getFormularioFormularioCampoCompartment_7005SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<WorkflowNodeDescriptor> childDescriptors = WorkflowDiagramUpdater
				.getFormularioFormularioCampoCompartment_7005SemanticChildren((View) getHost().getModel());
