...
import workflow.diagram.edit.commands.UsuarioFormularioCreateCommand;
import workflow.diagram.edit.commands.UsuarioFormularioReorientCommand;
 ...
 * @generated
 */
public class FormularioItemSemanticEditPolicy extends WorkflowBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public FormularioItemSemanticEditPolicy() {
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (WorkflowVisualIDRegistry.getVisualID(incomingLink) == TablaFormularioEditPart.VISUAL_ID) {
			...
			if (WorkflowVisualIDRegistry.getVisualID(incomingLink) == UsuarioFormularioEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
	...
	*/
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (WorkflowElementTypes.UsuarioFormulario_4003 == req.getElementType()) {
			return null;
		}
		return null;
	}
	...
	protected Command getCompleteCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (WorkflowElementTypes.UsuarioFormulario_4003 == req.getElementType()) {
			return getGEFWrapper(new UsuarioFormularioCreateCommand(req, req.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	protected Command getReorientReferenceRelationshipCommand(ReorientReferenceRelationshipRequest req) {
		...
		case UsuarioFormularioEditPart.VISUAL_ID:
			return getGEFWrapper(new UsuarioFormularioReorientCommand(req));
		}
