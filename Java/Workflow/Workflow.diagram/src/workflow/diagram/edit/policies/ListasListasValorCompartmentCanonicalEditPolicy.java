 ...
 * @generated
 */
public class ListasListasValorCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return WorkflowPackage.eINSTANCE.getListas_Valor();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WorkflowNodeDescriptor> childDescriptors = WorkflowDiagramUpdater
				.getListasListasValorCompartment_7006SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ValorEditPart.VISUAL_ID == WorkflowVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<WorkflowNodeDescriptor> childDescriptors = WorkflowDiagramUpdater
				.getListasListasValorCompartment_7006SemanticChildren((View) getHost().getModel());
