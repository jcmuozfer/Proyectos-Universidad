 ...
 * @generated
 */
public class UsuarioItemSemanticEditPolicy extends WorkflowBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public UsuarioItemSemanticEditPolicy() {
		super(WorkflowElementTypes.Usuario_3002);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (WorkflowVisualIDRegistry.getVisualID(outgoingLink) == UsuarioFormularioEditPart.VISUAL_ID) {
