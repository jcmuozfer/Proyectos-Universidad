...
import workflow.diagram.edit.commands.ActorCreateCommand;
import workflow.diagram.edit.commands.BaseDatosCreateCommand;
...
public class WorkflowItemSemanticEditPolicy extends WorkflowBaseItemSemanticEditPolicy {
	...
	*/
	protected Command getCreateCommand(CreateElementRequest req) {
		if (WorkflowElementTypes.BaseDatos_2001 == req.getElementType()) {
			return getGEFWrapper(new BaseDatosCreateCommand(req));
		}
		if (WorkflowElementTypes.Actor_2002 == req.getElementType()) {
