...
/**
 * This is the item provider adapter for a {@link workflow.Actor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActorItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkflowPackage.Literals.ACTOR__NOMBRE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkflowPackage.Literals.ACTOR__NUM_TAREAS,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkflowPackage.Literals.ACTOR__FICHERO);
			childrenFeatures.add(WorkflowPackage.Literals.ACTOR__FORMULARIO);
			childrenFeatures.add(WorkflowPackage.Literals.ACTOR__TAREA);
			childrenFeatures.add(WorkflowPackage.Literals.ACTOR__ENLACE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.ACTOR__FICHERO,
				 WorkflowFactory.eINSTANCE.createFichero()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.ACTOR__FORMULARIO,
				 WorkflowFactory.eINSTANCE.createFormulario()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.ACTOR__TAREA,
				 WorkflowFactory.eINSTANCE.createInicio()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.ACTOR__TAREA,
				 WorkflowFactory.eINSTANCE.createFin()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.ACTOR__TAREA,
				 WorkflowFactory.eINSTANCE.createUsuario()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.ACTOR__TAREA,
				 WorkflowFactory.eINSTANCE.createServicio()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.ACTOR__TAREA,
				 WorkflowFactory.eINSTANCE.createEnvioMensaje()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.ACTOR__TAREA,
				 WorkflowFactory.eINSTANCE.createRecepcionMensaje()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.ACTOR__TAREA,
				 WorkflowFactory.eINSTANCE.createConsultaBD()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.ACTOR__TAREA,
				 WorkflowFactory.eINSTANCE.createBorradoBD()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.ACTOR__ENLACE,
				 WorkflowFactory.eINSTANCE.createEnlace()));
	}
