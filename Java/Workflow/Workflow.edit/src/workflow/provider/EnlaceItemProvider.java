...
/**
 * This is the item provider adapter for a {@link workflow.Enlace} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkflowPackage.Literals.ENLACE__DESTINO,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkflowPackage.Literals.ENLACE__ORIGEN,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNombrePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Enlace_nombre_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Enlace_nombre_feature", "_UI_Enlace_type"),
				 WorkflowPackage.Literals.ENLACE__NOMBRE,
				 true,
				 false,
				 false,
