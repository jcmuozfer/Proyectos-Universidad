...
/**
 * This is the item provider adapter for a {@link workflow.Tabla} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TablaItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addFormularioPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkflowPackage.Literals.TABLA__NOMBRE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Formulario feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFormularioPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tabla_formulario_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tabla_formulario_feature", "_UI_Tabla_type"),
				 WorkflowPackage.Literals.TABLA__FORMULARIO,
				 true,
				 false,
				 true,
				 null,
