...
public class WorkflowItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Workflow_nombre_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Workflow_nombre_feature", "_UI_Workflow_type"),
				 WorkflowPackage.Literals.WORKFLOW__NOMBRE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkflowPackage.Literals.WORKFLOW__BASEDATOS);
			childrenFeatures.add(WorkflowPackage.Literals.WORKFLOW__ACTOR);
		}
	...
	public String getText(Object object) {
		String label = ((Workflow)object).getNombre();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.WORKFLOW__BASEDATOS,
				 WorkflowFactory.eINSTANCE.createBaseDatos()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.WORKFLOW__ACTOR,
				 WorkflowFactory.eINSTANCE.createActor()));
	}
