...
public let uknownFotoImage = UIImage(contentsOfFile: pathToUnkwonFoto.path)
...
public class Figura : NSObject, NSCoding, NSSecureCoding{
    ...
    public var altura: String
    public var material : String
    public var cantidad : Int
    public var fecha : Int
    public var foto : UIImage? = nil
    public var fotoNombre : String
    public var fabricante : String
    
    public override init() {
        self.identificador = "identificador"
        self.altura = "altura"
        self.material = "Lienzo"
        self.cantidad = 1
        self.fecha = 2022
        self.fabricante = "fabricante"
        self.fotoNombre = "null.png"
        self.foto = uknownFotoImage
